...
class App extends Component {
  getTextScroller = () => (
    <TextScroller
      fixed="Professional"
      values={['Software Engineer', 'Front End Developer', 'Java Developer', 'JavaScript Engineer']}
    />
  );
  ...
  render() {
    return (
      <div className="GridContainer">
        ...
        <TextBox className="HeaderBox title-area bg-gray" value={<h2>Steven Silvestri</h2>} />
        <IconBox
          className="download-area hvr-sweep-to-right bg-light-gray"
          ...
          external
        />
        <TextBox className="HeaderBox position-area bg-light-gray" value={this.getTextScroller()} />
        <IconBox
          className="linkedin-area hvr-sweep-to-right bg-gray"
        ...
        <footer className="footer-area container-fluid">
          <div className="row">
            <div className="col-sm-6 col-md-4">
              ...
              <small>&copy; Steven Silvestri 2017</small>
            </div>
            <div className="col-sm-6 col-md-4">
              <h4>Download CV</h4>
              <p>
